...
- Added automated backend environment setup scripts for separate MACE and UMA
  environments.
- Added hello-world examples that train, predict, and generate a UQ profile
  visualization.
- Added a pre-merge validation plan for core, MACE, and UMA workflows.
